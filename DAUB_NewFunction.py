...
def daub_tables_check(df1):
    ...
    if total_percentage_finer_on_size_0_075.item() < 5:
        print("Fines Content Classified as Very Low.")
        ...
        print("Fines Content Classified as Low.")
